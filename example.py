...
# Example file for the pyepoch module.

# Import the pyepoch module:
import pyepoch
...
# The pyepoch_sec() function returns the seconds from the UNIX epoch (1970, 1, 1) to the inputed date.
